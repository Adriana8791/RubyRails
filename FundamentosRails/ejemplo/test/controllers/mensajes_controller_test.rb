...
class MensajesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create mensaje" do
    assert_difference('Mensaje.count') do
      post mensajes_url, params: { mensaje: { comentario_id: @mensaje.comentario_id, usuario_id: @mensaje.usuario_id } }
    end
  ...
  test "should update mensaje" do
    patch mensaje_url(@mensaje), params: { mensaje: { comentario_id: @mensaje.comentario_id, usuario_id: @mensaje.usuario_id } }
